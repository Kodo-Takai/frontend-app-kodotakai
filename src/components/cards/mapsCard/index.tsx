...
const FALLBACK = { lat: 10.3, lng: -75.5 }; // Parque Nacional Natural de los Corales del Rosario y San Bernardo, Cartagena
      ...
      const map = new window.google.maps.Map(miniMapRef.current, {
        ...
        styles: [
          ...
          }, // Bone para tierra
          {
            featureType: "road",
            elementType: "geometry",
            stylers: [{ color: "#4A7A8A" }],
          }, // Blue light para calles
          {
            featureType: "road",
            elementType: "labels.text.fill",
            stylers: [{ color: "#295B72" }],
          }, // Blue para texto de calles
          {
  ...
  if (placesLoading || !window.google?.maps) {
    return (
      <div className={`${className} min-w-[160px]`}>
        <div className="rounded-2xl border border-[var(--color-bone)] bg-[var(--color-blue-light)] shadow-sm overflow-hidden h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xs font-medium text-[var(--color-bone)]">
              Cargando mapa...
            </p>
          </div>
        </div>
