    ...
    <div className="w-full h-57 mb-3">
      ...
      <div className="grid grid-cols-5 gap-2 h-32">
        <div className="col-span-3 h-full">
          <MapsCard className="w-full h-full animate-bubble-in" />
        </div>
        <div className="col-span-2 flex flex-col gap-5 h-full">
          <div className="flex-[3] ">
            <WeatherCard className="w-full h-full animate-bubble-in" />
          </div>
          <div className="flex-[2] relative z-20 animate-bubble-in">
            <CalendarCard />
          </div>
        </div>
      </div>
